...
func (a *App) generateHelpText() string {
	...
	fmt.Fprintf(&help, "      └ in panel: Enter open in reader · %s AI-assist read-manually · %s remember rule · %s view prompt · %s move · %s exclude · %s confirm whole plan (press twice)\n\n", a.Keys.AssistReadManually, a.Keys.RememberRule, a.Keys.ViewPrompt, a.Keys.Move, a.Keys.BulkSelect, a.Keys.ConfirmPlan)
