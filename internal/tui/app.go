...
func (a *App) generateHelpText() string {
	...
	fmt.Fprintf(&help, "      └ in panel: Enter open in reader · %s AI-assist read-manually · %s accept suggestion (email/sender group, press twice) · %s remember rule · %s view prompt · %s move · %s exclude · %s confirm whole plan (press twice)\n\n", a.Keys.AssistReadManually, a.Keys.AcceptSuggestion, a.Keys.RememberRule, a.Keys.ViewPrompt, a.Keys.Move, a.Keys.BulkSelect, a.Keys.ConfirmPlan)
