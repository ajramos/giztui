...
func actionPlanKeyHints(keys actionPlanFooterKeys) []KeyHint {
	return []KeyHint{
		...
		{Key: prettyKeyLabel(keys.assist), Desc: "Read manually: AI hint + suggested action (on demand)"},
		{Key: prettyKeyLabel(keys.accept), Desc: "Read manually: accept the suggestion (email / sender group)"},
